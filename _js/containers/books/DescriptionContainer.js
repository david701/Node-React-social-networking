...
export default class DescriptionContainer extends React.Component {
  ...
  render() {
    return (
      <Description bookId={this.props.bookId} description={this.state.description} toggleStatus={this.props.toggleStatus} following={this.props.following} authorized={this.props.authorized}/>
    );
  }
}
